...
// We do expect exactly one instance to be put there via a call to dispatchShielderEvent by the
...
// dispatchShielderEvent by the keyper from a different goroutine. The call times out when with
