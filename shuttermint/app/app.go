...
// LoadShielderAppFromFile loads a shielder app from a file
func LoadShielderAppFromFile(gobpath string) (ShielderApp, error) {
	var shapp ShielderApp
	gobfile, err := os.Open(gobpath)
	if os.IsNotExist(err) {
		shapp = *NewShielderApp()
	} else if err != nil {
		return shapp, err
	} else {
		defer gobfile.Close()
...
func (app *ShielderApp) checkConfig(cfg BatchConfig) error {
	err := cfg.EnsureValid()
	if err != nil {
		return err
	}
...
func (app *ShielderApp) updateCheckTxMembers() {
...
func (app *ShielderApp) Info(req abcitypes.RequestInfo) abcitypes.ResponseInfo {
...
func (ShielderApp) ListSnapshots(abcitypes.RequestListSnapshots) abcitypes.ResponseListSnapshots {
	return abcitypes.ResponseListSnapshots{}
}

func (ShielderApp) LoadSnapshotChunk(abcitypes.RequestLoadSnapshotChunk) abcitypes.ResponseLoadSnapshotChunk {
	return abcitypes.ResponseLoadSnapshotChunk{}
}

func (ShielderApp) ApplySnapshotChunk(abcitypes.RequestApplySnapshotChunk) abcitypes.ResponseApplySnapshotChunk {
	return abcitypes.ResponseApplySnapshotChunk{}
}

func (ShielderApp) OfferSnapshot(abcitypes.RequestOfferSnapshot) abcitypes.ResponseOfferSnapshot {
...
*/
func (app *ShielderApp) InitChain(req abcitypes.RequestInitChain) abcitypes.ResponseInitChain {
...
func (ShielderApp) decodeTx(tx []byte) (signer common.Address, msg *shmsg.MessageWithNonce, err error) {
	var signedMsg []byte
...
func (app *ShielderApp) allowedToVoteOnConfigChanges(sender common.Address) bool {
	lastConfig := app.LastConfig()
...
func (app *ShielderApp) isKeyper(a common.Address) bool {
...
func (app *ShielderApp) deliverCheckIn(msg *shmsg.CheckIn, sender common.Address) abcitypes.ResponseDeliverTx {
...
func (app *ShielderApp) deliverBatchConfigStarted(msg *shmsg.BatchConfigStarted, sender common.Address) abcitypes.ResponseDeliverTx {
...
func (app *ShielderApp) deliverEonStartVoteMsg(msg *shmsg.EonStartVoteMsg, sender common.Address) abcitypes.ResponseDeliverTx {
...
func (app *ShielderApp) countEonStartVote(sender common.Address, config *BatchConfig, startBatchIndex uint64) {
...
func (app *ShielderApp) maybeStartEon(config *BatchConfig) (*DKGInstance, uint64, bool) {
...
func (app *ShielderApp) deliverDecryptionSignature(msg *shmsg.DecryptionSignature, sender common.Address) abcitypes.ResponseDeliverTx {
...
func (app *ShielderApp) handlePolyEvalMsg(msg *shmsg.PolyEvalMsg, sender common.Address) abcitypes.ResponseDeliverTx {
...
func (app *ShielderApp) handlePolyCommitmentMsg(msg *shmsg.PolyCommitmentMsg, sender common.Address) abcitypes.ResponseDeliverTx {
...
func (app *ShielderApp) handleAccusationMsg(msg *shmsg.AccusationMsg, sender common.Address) abcitypes.ResponseDeliverTx {
...
func (app *ShielderApp) handleApologyMsg(msg *shmsg.ApologyMsg, sender common.Address) abcitypes.ResponseDeliverTx {
...
// changed
func (app *ShielderApp) ShouldStartDKG(config BatchConfig) bool {
...
func (app *ShielderApp) StartDKG(config BatchConfig) *DKGInstance {
	app.EONCounter++
...
func (app *ShielderApp) LastConfig() *BatchConfig {
...
func (app *ShielderApp) makePowermap(keypers []common.Address) Powermap {
	pm := make(Powermap)
...
func (app *ShielderApp) CurrentValidators() Powermap {
	for i := len(app.Configs) - 1; i >= 0; i-- {
...
func (app *ShielderApp) countCheckedInKeypers(keypers []common.Address) uint64 {
...
func (app *ShielderApp) EndBlock(req abcitypes.RequestEndBlock) abcitypes.ResponseEndBlock {
	lastConfig := app.LastConfig()
...
func (app *ShielderApp) maybePersistToDisk() error {
	if app.Gobpath == "" {
		return nil
	}
