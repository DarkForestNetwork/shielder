...
import (
	...
	"shielder/shuttermint/contracts/configcontract"
	"shielder/shuttermint/contracts/keybroadcastcontract"
...
var rootCmd = &cobra.Command{
	Use:   "deploy",
	Short: "Helper tools to deploy and interact with the Shielder contracts",
