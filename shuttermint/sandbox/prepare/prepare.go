...
func rawConfig(keyperIndex int) (*cmd.RawKeyperConfig, error) {
	...
	if configFlags.FixedShielderPort {
		shuttermintPort = configFlags.FirstShielderPort
	} else {
